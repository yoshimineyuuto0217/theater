      ...
      <div class="header-fixed">
        <div class="header-fixed-inner">
          <div class="header-row left">
            <h1 class="header-logo"><a href="#pageTop"><img src="<?php the_field('logo_pc'); ?>" alt="theater"
                  width="155" height="178"></a></h1>
          </div>
          <div class="right">
            <nav class="header-navi-wrapper pc">
              <ul class="header-navi bottom not-common">
                <li class="item"><a class="link font-en navi1" href="#about">ABOUT</a></li>
                <li class="item"><a class="link font-en navi2" href="#works">WORKS</a></li>
                <li class="item"><a class="link font-en navi3" href="#company">COMPANY</a></li>
                <li class="item"><a class="link font-en navi4" href="#contact">CONTACT</a></li>
  ...
  <header class="header" id="header">
    <div class="header-wrapper">
      <div class="header-fixed">
        <div class="header-fixed-inner">
          <div class="header-row left">
            <h1 class="header-logo black"><a href="#pageTop"><img src="<?php the_field('scroll_logo'); ?>"alt="theater"
                  width="240" height="54"></a></h1>
            <h1 class="header-logo white"><a href="#pageTop"><img src="<?php the_field('scroll_logo'); ?>"
                  alt="theater" width="240" height="54"></a></h1>
          </div>
          <div class="right">
            ...
            <div class="block-wrapper">
              <div class="navi-top">
                <ul class="header-navi not-common">
                  <li class="item"><a class="link font-en navi0" href="#pageTop">TOP</a></li>
                  <li class="item"><a class="link font-en navi1" href="#about">ABOUT</a></li>
                  <li class="item"><a class="link font-en navi2" href="#works">WORKS</a></li>
                  <li class="item"><a class="link font-en navi3" href="#company">COMPANY</a></li>
                  <li class="item"><a class="link font-en navi4" href="#contact">CONTACT</a></li>
